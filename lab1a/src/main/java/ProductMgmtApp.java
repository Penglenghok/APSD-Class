...
public class ProductMgmtApp {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Product productA = new Product("3128874119", "Banana", new Date("2023/01/24"), 124, 0.55);
        Product productB = new Product("2927458265", "Apple", new Date("2022/12/09"), 18, 1.09);
        Product productC = new Product("9189927460", "Carrot", new Date("2023/03/31"), 89, 2.99);
